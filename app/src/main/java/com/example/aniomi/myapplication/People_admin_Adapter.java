...
public class People_admin_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<Students> list = new ArrayList<Students>();
    private Context context;
    private DatabaseReference mDatabase;
    private FirebaseAuth mAuth;
    public People_admin_Adapter(Context context,ArrayList<Students> list) {
        this.list = list;
